...
-- import Language.Haskell.Tools.Debug.CCGenerics
import Language.Haskell.Tools.Debug.RangeDebugInstances ()
-- import Language.Haskell.Tools.Debug.CCGenericsInstances ()
import Language.Haskell.Tools.PrettyPrint (prettyPrint)
import Language.Haskell.Tools.PrettyPrint.Prepare
import Language.Haskell.Tools.Refactor
import Language.Haskell.Tools.Refactor.Builtin (builtinRefactorings)

import Language.Haskell.Tools.Refactor.Builtin.CloneDetection (showCloneMatrix, showClones)
...
--     liftIO $ putStrLn $ srcInfoDebug transformed
    ...
    liftIO $ putStrLn "=========== matrices:"
    liftIO $ putStrLn $ showCloneMatrix transformed
    liftIO $ putStrLn $ showClones transformed
